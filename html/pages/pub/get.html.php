...
# define page title
define("HEADING_TITLE", "Download the Public Key.");

$result = "";
if ((null !== RESULT) && (false === ERROR)) {
  $result = html(RESULT);
} else {
  $result = "<strong>ERROR:</strong> ".html(RESULT);
}
...
?>
  ...
  <h2>Download the Public Key:</h2>
  <pre class="bg-light border rounded" id="pubkey"><?= $result ?></pre>
